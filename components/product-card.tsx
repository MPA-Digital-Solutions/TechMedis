...
export function ProductCard({ product, whatsappNumber = "5491112345678" }: ProductCardProps) {
  ...
  const conversionClass = CATEGORY_CONVERSION_CLASS[product.category] ?? "";
        ...
        <div className="flex flex-col flex-grow p-8 lg:w-3/5">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-auto">
            ...
            <a
              ...
              className={`${conversionClass} flex-1 flex items-center justify-center gap-2 py-4 px-6 bg-green-500 text-white font-semibold rounded-xl hover:bg-green-600 transition-all duration-300 shadow-md hover:shadow-lg hover:scale-[1.02]`}
            >
