...
export const metadata: Metadata = {
    title: "Sistemas PAC RIS - Techmedis",
    description: "Sistemas PAC y RIS para gestión de imágenes médicas. Soluciones integrales para radiología digital.",
};
...
export default async function SistemasPacRisPage({ searchParams }: PageProps) {
    ...
    const [products, whatsappNumber] = await Promise.all([
        getProducts({ category: "sistemas-pac-ris", status: "active" }),
        getWhatsAppNumber(),
    ]);
    ...
    const selectedSubcategoryObj = selectedSubcategory
        ? SUBCATEGORIES["sistemas-pac-ris"].find((sub) => sub.slug === selectedSubcategory)
        : null;
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className="text-xl text-white/90 font-light leading-relaxed">
                                Soluciones integrales de PACS y RIS para gestión, almacenamiento
            ...
            <section className="py-16 md:py-24 bg-techmedis-light">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <ProductsGrid
                        ...
                        emptyMessage="No hay sistemas PAC RIS disponibles en esta subcategoría."
