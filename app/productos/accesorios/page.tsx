...
export const metadata: Metadata = {
    title: "Accesorios - Techmedis",
    description: "Accesorios complementarios para equipamiento médico y sistemas de diagnóstico por imágenes.",
};
...
export default async function AccesoriosPage({ searchParams }: PageProps) {
    ...
    const [products, whatsappNumber] = await Promise.all([
        getProducts({ category: "accesorios", status: "active" }),
        getWhatsAppNumber(),
    ]);
    ...
    const selectedSubcategoryObj = selectedSubcategory
        ? SUBCATEGORIES["accesorios"].find((sub) => sub.slug === selectedSubcategory)
        : null;
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className="text-xl text-white/90 font-light leading-relaxed">
                                Accesorios complementarios para equipamiento médico y sistemas
            ...
            <section className="py-16 md:py-24 bg-techmedis-light">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <ProductsGrid
                        ...
                        emptyMessage="No hay accesorios disponibles en esta subcategoría."
