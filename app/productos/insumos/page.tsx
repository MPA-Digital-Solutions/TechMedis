...
export default async function InsumosPage({ searchParams }: PageProps) {
    ...
    const [products, whatsappNumber] = await Promise.all([
        getProducts({ category: "insumos", status: "active" }),
        getWhatsAppNumber(),
    ]);
    ...
    const selectedSubcategoryObj = selectedSubcategory
        ? SUBCATEGORIES["insumos"].find((sub) => sub.slug === selectedSubcategory)
        : null;
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className="text-xl text-white/90 font-light leading-relaxed">
                                Insumos y suministros para el funcionamiento óptimo
            ...
            <section className="py-16 md:py-24 bg-techmedis-light">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <ProductsGrid
                        ...
                        emptyMessage="No hay insumos disponibles en esta subcategoría."
