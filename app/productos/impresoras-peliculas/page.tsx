...
export const metadata: Metadata = {
    title: "Impresoras de Películas - Techmedis",
    description: "Impresoras de películas médicas de alta calidad. Soluciones de impresión para diagnóstico por imágenes.",
};
...
export default async function ImpresorasPeliculasPage({ searchParams }: PageProps) {
    ...
    const [products, whatsappNumber] = await Promise.all([
        getProducts({ category: "impresoras-peliculas", status: "active" }),
        getWhatsAppNumber(),
    ]);
    ...
    const selectedSubcategoryObj = selectedSubcategory
        ? SUBCATEGORIES["impresoras-peliculas"].find((sub) => sub.slug === selectedSubcategory)
        : null;
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className="text-xl text-white/90 font-light leading-relaxed">
                                Impresoras de películas médicas con tecnología de punta para obtener
            ...
            <section className="py-16 md:py-24 bg-techmedis-light">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <ProductsGrid
                        ...
                        emptyMessage="No hay impresoras de películas disponibles en esta subcategoría."
