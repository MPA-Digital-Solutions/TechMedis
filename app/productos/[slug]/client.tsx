...
export function ProductDetailClient({ product, relatedProducts, whatsappNumber = "5491112345678", carouselImages = [] }: ProductDetailClientProps) {
  ...
  // Map categoría a clase de conversión
  const CATEGORY_CONVERSION_CLASS: Record<string, string> = {
    "radiologia": "conversion-radiologia",
    "mamografia": "conversion-mamografia",
    "impresoras-dicom": "conversion-impresoras",
  };
  const conversionClass = CATEGORY_CONVERSION_CLASS[product.category] ?? "conversion-cta";
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 mt-auto">
                <a
                  ...
                  className={`${conversionClass} flex-1 inline-flex items-center justify-center bg-green-500 hover:bg-green-600 text-white font-semibold py-4 px-6 rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-[1.02]`}
                >
